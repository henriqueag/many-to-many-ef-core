...
namespace Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [HttpGet("api/security/google-login")]
        public IActionResult GoogleLoginApi()
        {
            string redirectUrl = "api/security/login-response";
            var properties = signInManager.ConfigureExternalAuthenticationProperties("Google", redirectUrl);
            return new ChallengeResult("Google", properties);
        }

        [AllowAnonymous]
        [HttpGet("api/security/login-response")]
        public async Task<IActionResult> GoogleResponseApi()
        {
